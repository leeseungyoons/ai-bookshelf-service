...
- 도서 관리 서비스 기능 설계 및 구현 참여
- 사용자 인증 / 도서 CRUD / 외부 도서 검색 / AI 표지 생성 플로우 구현 참여
- OpenAI 이미지 생성 API 연동
- YES24 크롤링 기능 구현 또는 연동
- 백엔드 API와 프론트엔드 화면 연결
- AWS EKS 기반 배포 및 인프라 구성 참여
- CI/CD 파이프라인 구축 및 배포 자동화 과정 참여

> 위 역할은 실제 본인 담당 범위에 맞게 세부 수정해서 사용하세요.
